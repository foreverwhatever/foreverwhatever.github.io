...
c.TemplateExporter.template_file = '_layouts/jekyll.md.tpl';c.TemplateExporter.filters = {'dump': 'json.dumps', 'load': 'json.loads', 'yaml': 'yaml.dump'};c.ExtractOutputPreprocessor.enabled=False;
